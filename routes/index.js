...
router.get('/:id', function (req, res, next) {
  ...
  if(bp) {
    const user = {
      name: 'SkimnerPhi',
      avatar:
        'https://cdn.discordapp.com/avatars/199729873193926656/7894fb3b82a5075ddeae0a5626c68a37.webp?size=128',
    };
